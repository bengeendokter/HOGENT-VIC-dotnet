...
/// <summary>
/// Acts like a database trigger but is database agnostic and executes on <see cref="VicDbContext"/> SaveChanged(async) is called right before executing the query.
